  ...
  //   apiKey: "AIzaSyD459PGC_kCqdiddns7XbW9lf3NNiyLby0",
  //   authDomain: "snake-game-e2314.firebaseapp.com",
  //   projectId: "snake-game-e2314",
  //   storageBucket: "snake-game-e2314.appspot.com",
  //   messagingSenderId: "94488980773",
  //   appId: "1:94488980773:web:507116352e0c916d26fecc"
  // };
...
var span = document.getElementById("highest")
...
function startSnake() {
  ...
  span.innerText = window.localStorage.getItem('highScore')
}
  snake.time = 1;
  renderSnake();
  randomFood();
...
function stopp() {
  ...
  span.innerText = snake.score;
  var highScore = window.localStorage.getItem('highScore')
  if(highScore == null){
   window.localStorage.setItem("highScore",snake.score.toString())
}else{
